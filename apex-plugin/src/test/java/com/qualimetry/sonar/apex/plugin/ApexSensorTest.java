...
class ApexSensorTest {

    @Test
    void shouldDescribeWithCorrectName() {
        FileSystem fileSystem = mock(FileSystem.class);
        CheckFactory checkFactory = mock(CheckFactory.class);
        ApexSensor sensor = new ApexSensor(fileSystem, checkFactory);
        ...
        verify(descriptor).onlyOnLanguage("apex");
        verify(descriptor).name("Apex Analyzer Sensor");
    ...
    void shouldCreateSensorWithCorrectDependencies() {
        ...
        verify(descriptor).onlyOnLanguage(ApexLanguage.KEY);
    }
}
